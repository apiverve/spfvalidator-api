...
namespace APIVerve.API.SPFValidator
{
    ...
    /// <summary>
    /// Client for the SPFValidator API
    /// </summary>
    public class SPFValidatorAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/spfvalidator";
        ...
        {
            { "domain", new ValidationRule { Type = "string", Required = true, Format = "domain" } }
        };
        ...
        public SPFValidatorAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SPFValidatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public SPFValidatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, SPFValidatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(SPFValidatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(SPFValidatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(SPFValidatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(SPFValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(SPFValidatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(SPFValidatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(SPFValidatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(SPFValidatorQueryOptions options)
        {
