// Package spfvalidator provides a Go client for the SPF Validator API.
//
// For more information, visit: https://spfvalidator.apiverve.com?utm_source=go&utm_medium=readme
package spfvalidator
...
// Request contains the parameters for the SPF Validator API.
//
// Parameters:
//   - domain (required): string - The domain to validate the SPF record for
type Request struct {
...
// ResponseData contains the data returned by the SPF Validator API.
type ResponseData struct {
	AuthorizedIps AuthorizedIpsData `json:"authorized_ips"`
	DnsLookupsNum int `json:"dns_lookups_num"`
	DomainsExtracted []string `json:"domains_extracted"`
	ElapsedMs int `json:"elapsed_ms"`
	HasIssues bool `json:"has_issues"`
	HasSpfRecord bool `json:"has_spf_record"`
	Host string `json:"host"`
	IpPass bool `json:"ip_pass"`
	MacrosFound bool `json:"macros_found"`
	SpfRecord string `json:"spf_record"`
	SpfRecordsList []SpfRecordsListItem `json:"spf_records_list"`
	SpfValid bool `json:"spf_valid"`
}

// AuthorizedIpsData represents the authorized_ips object.
type AuthorizedIpsData struct {
	Ipv4 []string `json:"ipv4"`
}

// SpfRecordsListItem represents an item in the SpfRecordsList array.
type SpfRecordsListItem struct {
	AuthorizedIps AuthorizedIpsData `json:"authorized_ips"`
	CharsNum int `json:"chars_num"`
	Domains []string `json:"domains"`
	Origin string `json:"origin"`
	Record string `json:"record"`
	UseMacro bool `json:"use_macro"`
}
