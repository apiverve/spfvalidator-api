...
const (
	baseURL        = "https://api.apiverve.com/v1/spfvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the SPF Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new SPF Validator API client.
...
// Execute makes a request to the SPF Validator API with typed parameters.
//
