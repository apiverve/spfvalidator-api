...
```gradle
dependencies {
    implementation 'com.github.apiverve:spfvalidator-api:1.1.13'
}
```
...
```java
import com.apiverve.spfvalidator.SPFValidatorAPIClient;
import com.apiverve.spfvalidator.APIResponse;
import com.apiverve.spfvalidator.APIException;

// Initialize the client
SPFValidatorAPIClient client = new SPFValidatorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("domain", "myspace.com");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/spfvalidator](https://docs.apiverve.com/ref/spfvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/spfvalidator](https://docs.apiverve.com/ref/spfvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/spfvalidator-api/issues)
