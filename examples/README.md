# SPF Validator API - Examples

This folder contains example code for using the SPF Validator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/spfvalidator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/spfvalidator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/spfvalidator](https://docs.apiverve.com/ref/spfvalidator)
